...
data <- readRDS('./data/local.rds')

metaData <- data@meta.data
metaData$sampleID <- rownames(metaData)
dataMatrix <- 	GetAssayData(object = data, slot = "counts")
...
generate <- function(nBulk, nGene, savePath, appendBulkCount = FALSE){
...
generate(nBulk = 100, nGene = 1e4, savePath = './data/sim/')
generate(nBulk = 100, nGene = 1e4, savePath = './data/scalability/', appendBulkCount = TRUE)
generate(nBulk = 250, nGene = 1e4, savePath = './data/scalability/', appendBulkCount = TRUE)
generate(nBulk = 500, nGene = 1e4, savePath = './data/scalability/', appendBulkCount = TRUE)
generate(nBulk = 1000, nGene = 1e4, savePath = './data/scalability/', appendBulkCount = TRUE)
